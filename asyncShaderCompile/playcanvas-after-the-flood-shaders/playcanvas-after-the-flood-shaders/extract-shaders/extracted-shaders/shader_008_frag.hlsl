...
uniform float3 _webgl_16cc37db4120bb6a : register(c26);
uniform float3 _webgl_2d459f8069f64681 : register(c27);
uniform float _webgl_c0eb2e332cfac9bd : register(c28);
...
(_webgl_8f7cfeb5dfbf859 = lerp(float3(0.039999999, 0.039999999, 0.039999999), _webgl_d7c0aae5deddf4ea, _webgl_c0eb2e332cfac9bd));
(_webgl_d7c0aae5deddf4ea = (_webgl_d7c0aae5deddf4ea * (1.0 - _webgl_c0eb2e332cfac9bd)));
...
(_webgl_9251dcdacdfa452 = (_webgl_9251dcdacdfa452 * ((pow(max(dot(normalize(((-_webgl_6b8507d7c52a30c5) + _webgl_dbb0b86db3589565)), _webgl_d189f73da6eb4d5b), 0.0), _webgl_24698dc60b28d11) * (_webgl_24698dc60b28d11 + 2.0)) / 8.0)));
...
(_webgl_9251dcdacdfa452 = (_webgl_9251dcdacdfa452 * ((pow(max(dot(normalize(((-_webgl_61c6aec6c44642a1) + _webgl_dbb0b86db3589565)), _webgl_d189f73da6eb4d5b), 0.0), _webgl_14255a09eade23c1) * (_webgl_14255a09eade23c1 + 2.0)) / 8.0)));
...
(_webgl_4a15523e4032dda7 = lerp((_webgl_d7c0aae5deddf4ea * _webgl_540f7c123bdf52c0), (_webgl_3d74e5997dd7c222 + (_webgl_82fa7c9f93cc7839.xyz * _webgl_7ae668e5b64ca8de)), _webgl_acb134d5a49c2148));
...
(out_webgl_9b98566002e557b5.x += 0.8432489);
}
void f_initGlobals()
{
