...
uniform float _webgl_c69990ec6a7a5be2 : register(c21);
...
float4 _webgl_a4f09ef54f1499bb = {0.0, 0.0, 0.0, 0.0};
float4 _webgl_2ef05ecaa6259cbe = {0.0, 0.0, 0.0, 0.0};
(_webgl_2ef05ecaa6259cbe.w = 1.0);
(_webgl_2ef05ecaa6259cbe.xyz = _webgl_5c81bf65ffac0762);
float4 _webgl_24698dc60b28d11 = {0.0, 0.0, 0.0, 0.0};
(_webgl_24698dc60b28d11 = mul(transpose(_webgl_80ac1a8d68a70197), _webgl_2ef05ecaa6259cbe));
(_webgl_a4f09ef54f1499bb.zw = _webgl_24698dc60b28d11.zw);
(_webgl_a4f09ef54f1499bb.xy = (_webgl_24698dc60b28d11.xy / _webgl_24698dc60b28d11.w));
float _webgl_91d95b04bf23fe42 = {0.0};
(_webgl_91d95b04bf23fe42 = ((sqrt(dot(_webgl_11482133dc10ada, _webgl_11482133dc10ada)) * _webgl_41a0cad7d2087d04.w) + _webgl_41a0cad7d2087d04.z));
float4 _webgl_af838643f97a28e8 = {0.0, 0.0, 0.0, 0.0};
(_webgl_af838643f97a28e8 = gl_texture2D(_webgl_b153a7264c2e8600, _webgl_a4f09ef54f1499bb.xy));
float3 _webgl_b3646d04812e7a4a = {0.0, 0.0, 0.0};
(_webgl_b3646d04812e7a4a.z = 0.0);
(_webgl_b3646d04812e7a4a.x = ((_webgl_af838643f97a28e8.y * 0.0039215689) + _webgl_af838643f97a28e8.x));
(_webgl_b3646d04812e7a4a.y = ((_webgl_af838643f97a28e8.w * 0.0039215689) + _webgl_af838643f97a28e8.z));
float _webgl_7edc71e79ab928c1 = {0.0};
(_webgl_7edc71e79ab928c1 = (_webgl_41a0cad7d2087d04.y * _webgl_91d95b04bf23fe42));
float _webgl_8badbc4aa9205681 = {0.0};
(_webgl_8badbc4aa9205681 = max((_webgl_b3646d04812e7a4a.y - (_webgl_b3646d04812e7a4a.x * _webgl_b3646d04812e7a4a.x)), (_webgl_7edc71e79ab928c1 * _webgl_7edc71e79ab928c1)));
float _webgl_e760ed8adca1c9c3 = {0.0};
(_webgl_e760ed8adca1c9c3 = (_webgl_91d95b04bf23fe42 - _webgl_b3646d04812e7a4a.x));
float _webgl_80f9c2f994f34f1e = {0.0};
(_webgl_80f9c2f994f34f1e = clamp((((_webgl_8badbc4aa9205681 / (_webgl_8badbc4aa9205681 + (_webgl_e760ed8adca1c9c3 * _webgl_e760ed8adca1c9c3))) - 0.1) / 0.89999998), 0.0, 1.0));
float _webgl_6a9bcb091df1cdf6 = {0.0};
if ((_webgl_91d95b04bf23fe42 <= _webgl_b3646d04812e7a4a.x))
{
(_webgl_6a9bcb091df1cdf6 = 1.0);
}
else
{
(_webgl_6a9bcb091df1cdf6 = _webgl_80f9c2f994f34f1e);
}
(_webgl_9251dcdacdfa452 = (_webgl_9251dcdacdfa452 * _webgl_6a9bcb091df1cdf6));
...
(_webgl_a52374383578cc70 = exp2((_webgl_8e684f5904e88831 * 11.0)));
float _webgl_e47f7fad6c31aebc = {0.0};
(_webgl_e47f7fad6c31aebc = max((_webgl_a52374383578cc70 * lerp(1.0, (1.0 / (1.0 + (_webgl_a52374383578cc70 * ((1.0 / clamp(sqrt(dot(_webgl_f28d072c82c61bea, _webgl_f28d072c82c61bea)), 0.0, 1.0)) - 1.0)))), _webgl_c72812b39ae458b)), 9.9999997e-05));
(_webgl_9251dcdacdfa452 = (_webgl_9251dcdacdfa452 * ((pow(max(dot(normalize(((-_webgl_6cd3ea4a4d7f2e24) + _webgl_dbb0b86db3589565)), _webgl_d189f73da6eb4d5b), 0.0), _webgl_e47f7fad6c31aebc) * (_webgl_e47f7fad6c31aebc + 2.0)) / 8.0)));
...
(_webgl_56077667bfd6d861 = lerp((_webgl_d7c0aae5deddf4ea * _webgl_540f7c123bdf52c0), (_webgl_3d74e5997dd7c222 + (_webgl_9d2f5706d0aa9ead.xyz * _webgl_9d2f5706d0aa9ead.w)), _webgl_acb134d5a49c2148));
...
(out_webgl_9b98566002e557b5.x += 0.32297465);
}
void f_initGlobals()
{
(_webgl_9d2f5706d0aa9ead = float4(0.0, 0.0, 0.0, 0.0));
