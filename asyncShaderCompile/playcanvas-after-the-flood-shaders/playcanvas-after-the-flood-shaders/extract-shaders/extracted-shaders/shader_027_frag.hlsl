...
uniform float _webgl_f26f4f7166479737 : register(c3);
...
(_webgl_f28d072c82c61bea = gl_texture2D(_webgl_d1a7cd505ae30fad, _webgl_c381ead4a4662b4a));
...
(out_webgl_9b98566002e557b5.x += 0.30597651);
}
void f_initGlobals()
{
