...
uniform float _webgl_d01a3af7717fc2f8[3] : register(c1);
...
(_webgl_38b555622b5f7ee0 = (_webgl_a0b62b4d8ddcd62b - (_webgl_df1a0b1dfe1c3652 * 1.5)));
{LOOP for(int _webgl_c9355afc1aa04056 = {0}; (_webgl_c9355afc1aa04056 < 3); (_webgl_c9355afc1aa04056++))
{
...
(_webgl_d898e30971ea19f = (_webgl_d898e30971ea19f + (_webgl_f8db25681e64559f.xyz * _webgl_d01a3af7717fc2f8[int_ctor(clamp(float_ctor(_webgl_c9355afc1aa04056), 0.0, 2.0))])));
}
}
...
(out_webgl_9b98566002e557b5.x += 0.66948217);
}
struct PS_INPUT
{
