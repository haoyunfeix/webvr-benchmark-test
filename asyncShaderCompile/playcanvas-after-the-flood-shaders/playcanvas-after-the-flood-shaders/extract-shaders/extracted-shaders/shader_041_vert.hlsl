...
uniform float4 _webgl_ee4006a19bf3daac : register(c11);
...
(_webgl_a01077f60b366ad8 = float2(0.0, 0.0));
...
(_webgl_a01077f60b366ad8 = ((_webgl_c8bdcf0e19b86378 * _webgl_ee4006a19bf3daac.xy) + _webgl_ee4006a19bf3daac.zw));
(_webgl_5c81bf65ffac0762.x += 0.98969793);
}
...
VS_OUTPUT main(VS_INPUT input)
{
    ...
    output.v4 = _webgl_a01077f60b366ad8;
    output.v5 = _webgl_c381ead4a4662b4a;
