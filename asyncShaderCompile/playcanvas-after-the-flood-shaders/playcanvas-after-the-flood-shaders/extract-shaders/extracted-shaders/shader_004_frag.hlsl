...
uniform float _webgl_78412eb5117922b0 : register(c26);
uniform float _webgl_c0eb2e332cfac9bd : register(c27);
...
(_webgl_2ef05ecaa6259cbe = normalize(_webgl_11482133dc10ada));
float _webgl_9d027aab757b6a55 = {0.0};
float _webgl_61c6aec6c44642a1 = {0.0};
(_webgl_61c6aec6c44642a1 = dot(_webgl_11482133dc10ada, _webgl_11482133dc10ada));
float _webgl_af838643f97a28e8 = {0.0};
(_webgl_af838643f97a28e8 = (1.0 / _webgl_1c82dc879cda6ae2));
(_webgl_9d027aab757b6a55 = ((1.0 / (_webgl_61c6aec6c44642a1 + 1.0)) * 16.0));
float _webgl_1027f416e3b7b976 = {0.0};
(_webgl_1027f416e3b7b976 = (_webgl_61c6aec6c44642a1 * (_webgl_af838643f97a28e8 * _webgl_af838643f97a28e8)));
float _webgl_7edc71e79ab928c1 = {0.0};
(_webgl_7edc71e79ab928c1 = clamp((1.0 - (_webgl_1027f416e3b7b976 * _webgl_1027f416e3b7b976)), 0.0, 1.0));
(_webgl_9d027aab757b6a55 = (_webgl_9d027aab757b6a55 * (_webgl_7edc71e79ab928c1 * _webgl_7edc71e79ab928c1)));
(_webgl_9251dcdacdfa452 = _webgl_9d027aab757b6a55);
if ((_webgl_9d027aab757b6a55 > 9.9999997e-06))
{
float _webgl_8badbc4aa9205681 = {0.0};
(_webgl_8badbc4aa9205681 = clamp(((dot(_webgl_2ef05ecaa6259cbe, _webgl_a8a39767ea2c8eb7) - _webgl_34ab7d99e8e69aa4) / (_webgl_e6010fd023fb284f - _webgl_34ab7d99e8e69aa4)), 0.0, 1.0));
(_webgl_9251dcdacdfa452 = (_webgl_9d027aab757b6a55 * (_webgl_8badbc4aa9205681 * (_webgl_8badbc4aa9205681 * (3.0 - (2.0 * _webgl_8badbc4aa9205681))))));
(_webgl_9251dcdacdfa452 = (_webgl_9251dcdacdfa452 * max(dot(_webgl_822b69d8b2db705f, (-_webgl_2ef05ecaa6259cbe)), 0.0)));
float4 _webgl_d20f765f80e4a0d9 = {0.0, 0.0, 0.0, 0.0};
float4 _webgl_80f9c2f994f34f1e = {0.0, 0.0, 0.0, 0.0};
(_webgl_80f9c2f994f34f1e.w = 1.0);
(_webgl_80f9c2f994f34f1e.xyz = _webgl_5c81bf65ffac0762);
float4 _webgl_6a9bcb091df1cdf6 = {0.0, 0.0, 0.0, 0.0};
(_webgl_6a9bcb091df1cdf6 = mul(transpose(_webgl_80ac1a8d68a70197), _webgl_80f9c2f994f34f1e));
(_webgl_d20f765f80e4a0d9.zw = _webgl_6a9bcb091df1cdf6.zw);
(_webgl_d20f765f80e4a0d9.xy = (_webgl_6a9bcb091df1cdf6.xy / _webgl_6a9bcb091df1cdf6.w));
float _webgl_4f48c34752f72758 = {0.0};
(_webgl_4f48c34752f72758 = ((sqrt(dot(_webgl_11482133dc10ada, _webgl_11482133dc10ada)) * _webgl_41a0cad7d2087d04.w) + _webgl_41a0cad7d2087d04.z));
float4 _webgl_e47f7fad6c31aebc = {0.0, 0.0, 0.0, 0.0};
(_webgl_e47f7fad6c31aebc = gl_texture2D(_webgl_b153a7264c2e8600, _webgl_d20f765f80e4a0d9.xy));
float3 _webgl_56077667bfd6d861 = {0.0, 0.0, 0.0};
(_webgl_56077667bfd6d861.z = 0.0);
(_webgl_56077667bfd6d861.x = ((_webgl_e47f7fad6c31aebc.y * 0.0039215689) + _webgl_e47f7fad6c31aebc.x));
(_webgl_56077667bfd6d861.y = ((_webgl_e47f7fad6c31aebc.w * 0.0039215689) + _webgl_e47f7fad6c31aebc.z));
float _webgl_b190a86bc7f938d2 = {0.0};
(_webgl_b190a86bc7f938d2 = (_webgl_41a0cad7d2087d04.y * _webgl_4f48c34752f72758));
float _webgl_95e254f0ea5b5564 = {0.0};
(_webgl_95e254f0ea5b5564 = max((_webgl_56077667bfd6d861.y - (_webgl_56077667bfd6d861.x * _webgl_56077667bfd6d861.x)), (_webgl_b190a86bc7f938d2 * _webgl_b190a86bc7f938d2)));
float _webgl_8e449eeb6739befe = {0.0};
(_webgl_8e449eeb6739befe = (_webgl_4f48c34752f72758 - _webgl_56077667bfd6d861.x));
float _webgl_eb9e29ad556d5876 = {0.0};
(_webgl_eb9e29ad556d5876 = clamp((((_webgl_95e254f0ea5b5564 / (_webgl_95e254f0ea5b5564 + (_webgl_8e449eeb6739befe * _webgl_8e449eeb6739befe))) - 0.1) / 0.89999998), 0.0, 1.0));
float _webgl_6430cdf0dbc8e939 = {0.0};
if ((_webgl_4f48c34752f72758 <= _webgl_56077667bfd6d861.x))
{
(_webgl_6430cdf0dbc8e939 = 1.0);
}
else
{
(_webgl_6430cdf0dbc8e939 = _webgl_eb9e29ad556d5876);
}
(_webgl_9251dcdacdfa452 = (_webgl_9251dcdacdfa452 * _webgl_6430cdf0dbc8e939));
...
(_webgl_909dd7b8eca80202 = max(exp2((_webgl_8e684f5904e88831 * 11.0)), 9.9999997e-05));
(_webgl_9251dcdacdfa452 = (_webgl_9251dcdacdfa452 * ((pow(max(dot(normalize(((-_webgl_2ef05ecaa6259cbe) + _webgl_dbb0b86db3589565)), _webgl_822b69d8b2db705f), 0.0), _webgl_909dd7b8eca80202) * (_webgl_909dd7b8eca80202 + 2.0)) / 8.0)));
...
(_webgl_9090da22dad28bf7 = lerp((_webgl_d7c0aae5deddf4ea * _webgl_540f7c123bdf52c0), (_webgl_3d74e5997dd7c222 + (_webgl_1e0a569fa8d323c5.xyz * _webgl_7ae668e5b64ca8de)), _webgl_acb134d5a49c2148));
(out_webgl_9b98566002e557b5.xyz = _webgl_9090da22dad28bf7);
float3 _webgl_14255a09eade23c1 = {0.0, 0.0, 0.0};
float4 _webgl_80e25d13c41fdf2 = {0.0, 0.0, 0.0, 0.0};
float4 _webgl_1d1ddb76fbcf772a = {0.0, 0.0, 0.0, 0.0};
(_webgl_1d1ddb76fbcf772a = gl_texture2D(_webgl_b15f7cf9d8241198, _webgl_a0b62b4d8ddcd62b));
(_webgl_80e25d13c41fdf2.w = _webgl_1d1ddb76fbcf772a.w);
(_webgl_80e25d13c41fdf2.xyz = pow(_webgl_1d1ddb76fbcf772a.xyz, float3(2.2, 2.2, 2.2)));
(_webgl_14255a09eade23c1 = (_webgl_80e25d13c41fdf2.xyz * _webgl_78412eb5117922b0));
(out_webgl_9b98566002e557b5.xyz = (out_webgl_9b98566002e557b5.xyz + _webgl_14255a09eade23c1));
float3 _webgl_e2e2a31b2325c72 = {0.0, 0.0, 0.0};
(_webgl_e2e2a31b2325c72 = (_webgl_5c81bf65ffac0762 - _webgl_35c9514d594e36f3));
(out_webgl_9b98566002e557b5.xyz = lerp(_webgl_3b3710b9db4788a7, out_webgl_9b98566002e557b5.xyz, clamp(exp(((-sqrt(dot(_webgl_e2e2a31b2325c72, _webgl_e2e2a31b2325c72))) * _webgl_5985a6d987efdfc3)), 0.0, 1.0)));
(out_webgl_9b98566002e557b5.xyz = out_webgl_9b98566002e557b5.xyz);
(out_webgl_9b98566002e557b5.xyz = out_webgl_9b98566002e557b5.xyz);
(out_webgl_9b98566002e557b5.w = 1.0);
(out_webgl_9b98566002e557b5.x += 0.26377994);
}
void f_initGlobals()
{
