...
static const uint _webgl_7b5e6932dac63e22 = 1;
static const uint textureIndexOffsetCube = 1;
static const uint samplerIndexOffsetCube = 1;
uniform TextureCube<float4> texturesCube[1] : register(t1);
uniform SamplerState samplersCube[1] : register(s1);
...
(out_webgl_9b98566002e557b5.xyz = out_webgl_9b98566002e557b5.xyz);
(out_webgl_9b98566002e557b5.w = _webgl_f26f4f7166479737);
(out_webgl_9b98566002e557b5.x += 0.78025317);
}
void f_initGlobals()
{
(_webgl_540f7c123bdf52c0 = float3(0.0, 0.0, 0.0));
