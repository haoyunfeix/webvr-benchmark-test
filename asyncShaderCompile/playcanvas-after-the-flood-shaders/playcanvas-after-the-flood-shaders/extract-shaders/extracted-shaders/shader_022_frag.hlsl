...
(_webgl_af27c8244adc12b9 = _webgl_dbb0b86db3589565.y);
if ((_webgl_dbb0b86db3589565.y < _webgl_d5b4509b9521f54c))
{
discard;
}
...
(_webgl_822b69d8b2db705f = (_webgl_5c81bf65ffac0762 - _webgl_35c9514d594e36f3));
(out_webgl_9b98566002e557b5.xyz = lerp(_webgl_3b3710b9db4788a7, out_webgl_9b98566002e557b5.xyz, clamp(exp(((-sqrt(dot(_webgl_822b69d8b2db705f, _webgl_822b69d8b2db705f))) * _webgl_5985a6d987efdfc3)), 0.0, 1.0)));
(out_webgl_9b98566002e557b5.xyz = out_webgl_9b98566002e557b5.xyz);
(out_webgl_9b98566002e557b5.xyz = out_webgl_9b98566002e557b5.xyz);
(out_webgl_9b98566002e557b5.w = _webgl_af27c8244adc12b9);
(out_webgl_9b98566002e557b5.x += 0.11053819);
}
void f_initGlobals()
{
