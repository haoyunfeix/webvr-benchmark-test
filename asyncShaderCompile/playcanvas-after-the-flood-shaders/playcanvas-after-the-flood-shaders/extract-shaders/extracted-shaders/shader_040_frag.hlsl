...
uniform float3 _webgl_e2179ae4f2cb06c9 : register(c4);
...
(_webgl_82fa7c9f93cc7839 = lerp((_webgl_be24a26eb209eebe.xyz * _webgl_3489059248406aa1), (_webgl_6b1576cc49ca380b.xyz * _webgl_7ae668e5b64ca8de), _webgl_acb134d5a49c2148));
(out_webgl_9b98566002e557b5.xyz = _webgl_82fa7c9f93cc7839);
float3 _webgl_6b8507d7c52a30c5 = {0.0, 0.0, 0.0};
float4 _webgl_fb6fbc72a915b4fc = {0.0, 0.0, 0.0, 0.0};
float4 _webgl_a5cbea098f008107 = {0.0, 0.0, 0.0, 0.0};
(_webgl_a5cbea098f008107 = gl_texture2D(_webgl_b15f7cf9d8241198, _webgl_a0b62b4d8ddcd62b));
(_webgl_fb6fbc72a915b4fc.w = _webgl_a5cbea098f008107.w);
(_webgl_fb6fbc72a915b4fc.xyz = pow(_webgl_a5cbea098f008107.xyz, float3(2.2, 2.2, 2.2)));
(_webgl_6b8507d7c52a30c5 = (_webgl_fb6fbc72a915b4fc.yyy * _webgl_2d459f8069f64681));
(out_webgl_9b98566002e557b5.xyz = (out_webgl_9b98566002e557b5.xyz + _webgl_6b8507d7c52a30c5));
float3 _webgl_e422f03590b051e5 = {0.0, 0.0, 0.0};
(_webgl_e422f03590b051e5 = (_webgl_5c81bf65ffac0762 - _webgl_35c9514d594e36f3));
(out_webgl_9b98566002e557b5.xyz = lerp(_webgl_3b3710b9db4788a7, out_webgl_9b98566002e557b5.xyz, clamp(exp(((-sqrt(dot(_webgl_e422f03590b051e5, _webgl_e422f03590b051e5))) * _webgl_5985a6d987efdfc3)), 0.0, 1.0)));
(out_webgl_9b98566002e557b5.xyz = out_webgl_9b98566002e557b5.xyz);
(out_webgl_9b98566002e557b5.xyz = out_webgl_9b98566002e557b5.xyz);
(out_webgl_9b98566002e557b5.w = 1.0);
(out_webgl_9b98566002e557b5.x += 0.80081993);
}
void f_initGlobals()
{
