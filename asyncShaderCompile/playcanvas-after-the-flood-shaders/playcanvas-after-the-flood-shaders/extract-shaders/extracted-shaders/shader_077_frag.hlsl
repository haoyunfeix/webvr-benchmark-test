...
(_webgl_6b8507d7c52a30c5 = max(((_webgl_1a380463a8bc7359 - sqrt(dot(_webgl_11482133dc10ada, _webgl_11482133dc10ada))) / _webgl_1a380463a8bc7359), 0.0));
(_webgl_9251dcdacdfa452 = _webgl_6b8507d7c52a30c5);
if ((_webgl_6b8507d7c52a30c5 > 9.9999997e-06))
{
float _webgl_bc517a070a88ef4a = {0.0};
(_webgl_bc517a070a88ef4a = clamp(((dot(_webgl_82fa7c9f93cc7839, _webgl_35202d7eed2427d) - _webgl_755af7149e45828a) / (_webgl_2dd2385497bef344 - _webgl_755af7149e45828a)), 0.0, 1.0));
(_webgl_9251dcdacdfa452 = (_webgl_6b8507d7c52a30c5 * (_webgl_bc517a070a88ef4a * (_webgl_bc517a070a88ef4a * (3.0 - (2.0 * _webgl_bc517a070a88ef4a))))));
...
(_webgl_dbaa033991f73c9d = max((_webgl_40d3fc5bec147c69 * lerp(1.0, (1.0 / (1.0 + (_webgl_40d3fc5bec147c69 * ((1.0 / clamp(sqrt(dot(_webgl_cfb863ec5a9ad847, _webgl_cfb863ec5a9ad847)), 0.0, 1.0)) - 1.0)))), _webgl_c72812b39ae458b)), 9.9999997e-05));
(_webgl_9251dcdacdfa452 = (_webgl_9251dcdacdfa452 * ((pow(max(dot(normalize(((-_webgl_82fa7c9f93cc7839) + _webgl_3c71294eb0cb894e)), _webgl_d189f73da6eb4d5b), 0.0), _webgl_dbaa033991f73c9d) * (_webgl_dbaa033991f73c9d + 2.0)) / 8.0)));
...
(_webgl_8a1c983d2a5521d3 = (_webgl_5c81bf65ffac0762 - _webgl_f836b86ccb55856c));
float2 _webgl_a8edb34b463f3ac3 = {0.0, 0.0};
(_webgl_a8edb34b463f3ac3 = (((_webgl_8a1c983d2a5521d3.xz / float2(16.0, -16.0)) * 0.5) + 0.5));
(_webgl_62c9d5f5e7dd3b43 = _webgl_a8edb34b463f3ac3);
(_webgl_feaeedca589c1a59 = 0.0);
if (((((_webgl_8a1c983d2a5521d3.x > -1.1) && (_webgl_8a1c983d2a5521d3.x < 1.1)) && (_webgl_8a1c983d2a5521d3.z > -1.1)) && (_webgl_8a1c983d2a5521d3.z < 1.1)))
{
...
{
{LOOP for(int _webgl_8d2839b9bb076ff7 = {0}; (_webgl_8d2839b9bb076ff7 < 8); (_webgl_8d2839b9bb076ff7++))
{
float4 _webgl_24698dc60b28d11 = {0.0, 0.0, 0.0, 0.0};
(_webgl_24698dc60b28d11 = gl_texture2D(_webgl_5c7c81c103b6fbdd, (_webgl_62c9d5f5e7dd3b43 + _webgl_a1324e053028e35c[int_ctor(clamp(float_ctor(_webgl_8d2839b9bb076ff7), 0.0, 7.0))])));
float _webgl_61c6aec6c44642a1 = {0.0};
(_webgl_61c6aec6c44642a1 = _webgl_24698dc60b28d11.w);
float3 _webgl_af838643f97a28e8 = {0.0, 0.0, 0.0};
if ((_webgl_feaeedca589c1a59 < _webgl_24698dc60b28d11.w))
{
float3 _webgl_b3646d04812e7a4a = {0.0, 0.0, 0.0};
(_webgl_b3646d04812e7a4a.xz = float2(0.125, 1.0));
(_webgl_b3646d04812e7a4a.y = _webgl_61c6aec6c44642a1);
(_webgl_af838643f97a28e8 = _webgl_b3646d04812e7a4a);
}
else
{
(_webgl_af838643f97a28e8 = float3(0.0, 0.0, 0.0));
}
(_webgl_91d068a447762d9f = (_webgl_91d068a447762d9f + _webgl_af838643f97a28e8));
}
}
...
(_webgl_7edc71e79ab928c1 = gl_texture2D(_webgl_5c7c81c103b6fbdd, _webgl_a8edb34b463f3ac3));
(_webgl_540f7c123bdf52c0 = (_webgl_540f7c123bdf52c0 * lerp(1.0, (1.0 - clamp(((_webgl_7edc71e79ab928c1.x - _webgl_7edc71e79ab928c1.y) * 4.0), 0.0, 1.0)), clamp(_webgl_cc88c95a9917294.y, 0.0, 1.0))));
}
float3 _webgl_8badbc4aa9205681 = {0.0, 0.0, 0.0};
(_webgl_8badbc4aa9205681 = lerp((_webgl_d7c0aae5deddf4ea * _webgl_540f7c123bdf52c0), (_webgl_3d74e5997dd7c222 + (_webgl_9d2f5706d0aa9ead.xyz * _webgl_9d2f5706d0aa9ead.w)), _webgl_acb134d5a49c2148));
(out_webgl_9b98566002e557b5.xyz = _webgl_8badbc4aa9205681);
...
(_webgl_e760ed8adca1c9c3 = (_webgl_5c81bf65ffac0762 - _webgl_35c9514d594e36f3));
(out_webgl_9b98566002e557b5.xyz = lerp(_webgl_3b3710b9db4788a7, out_webgl_9b98566002e557b5.xyz, clamp(exp(((-sqrt(dot(_webgl_e760ed8adca1c9c3, _webgl_e760ed8adca1c9c3))) * _webgl_5985a6d987efdfc3)), 0.0, 1.0)));
(out_webgl_9b98566002e557b5.xyz = out_webgl_9b98566002e557b5.xyz);
(out_webgl_9b98566002e557b5.xyz = out_webgl_9b98566002e557b5.xyz);
(out_webgl_9b98566002e557b5.w = 1.0);
(out_webgl_9b98566002e557b5.x += 0.69173336);
}
void f_initGlobals()
{
(_webgl_9d2f5706d0aa9ead = float4(0.0, 0.0, 0.0, 0.0));
