...
uniform float3 _webgl_2d459f8069f64681 : register(c14);
uniform float3 _webgl_e2179ae4f2cb06c9 : register(c15);
uniform float _webgl_508641f47c99a2ed : register(c16);
uniform float _webgl_7ae668e5b64ca8de : register(c17);
...
(_webgl_24698dc60b28d11 = lerp((_webgl_be24a26eb209eebe.xyz * _webgl_540f7c123bdf52c0), (_webgl_3d74e5997dd7c222 + (_webgl_6b1576cc49ca380b.xyz * _webgl_7ae668e5b64ca8de)), _webgl_acb134d5a49c2148));
(out_webgl_9b98566002e557b5.xyz = _webgl_24698dc60b28d11);
float3 _webgl_61c6aec6c44642a1 = {0.0, 0.0, 0.0};
float4 _webgl_d35e955ef44905f5 = {0.0, 0.0, 0.0, 0.0};
float4 _webgl_b3646d04812e7a4a = {0.0, 0.0, 0.0, 0.0};
(_webgl_b3646d04812e7a4a = gl_texture2D(_webgl_b15f7cf9d8241198, _webgl_a0b62b4d8ddcd62b));
(_webgl_d35e955ef44905f5.w = _webgl_b3646d04812e7a4a.w);
(_webgl_d35e955ef44905f5.xyz = pow(_webgl_b3646d04812e7a4a.xyz, float3(2.2, 2.2, 2.2)));
(_webgl_61c6aec6c44642a1 = (_webgl_d35e955ef44905f5.yyy * _webgl_2d459f8069f64681));
...
(out_webgl_9b98566002e557b5.x += 0.82527119);
}
void f_initGlobals()
{
(_webgl_540f7c123bdf52c0 = float3(0.0, 0.0, 0.0));
