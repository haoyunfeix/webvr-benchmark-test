...
uniform float _webgl_78412eb5117922b0 : register(c21);
...
(_webgl_9251dcdacdfa452 = (_webgl_9251dcdacdfa452 * max(dot(_webgl_dbb0b86db3589565, (-_webgl_f06ab770d8ec1876)), 0.0)));
...
float4 _webgl_c21d1224c18b7399 = {0.0, 0.0, 0.0, 0.0};
float4 _webgl_6b8507d7c52a30c5 = {0.0, 0.0, 0.0, 0.0};
(_webgl_6b8507d7c52a30c5 = gl_texture2D(_webgl_b15f7cf9d8241198, _webgl_a0b62b4d8ddcd62b));
(_webgl_c21d1224c18b7399.w = _webgl_6b8507d7c52a30c5.w);
(_webgl_c21d1224c18b7399.xyz = pow(_webgl_6b8507d7c52a30c5.xyz, float3(2.2, 2.2, 2.2)));
(_webgl_6b1576cc49ca380b = (_webgl_c21d1224c18b7399.xyz * _webgl_78412eb5117922b0));
(out_webgl_9b98566002e557b5.xyz = (out_webgl_9b98566002e557b5.xyz + _webgl_6b1576cc49ca380b));
...
(out_webgl_9b98566002e557b5.x += 0.73341304);
}
void f_initGlobals()
{
(_webgl_540f7c123bdf52c0 = float3(0.0, 0.0, 0.0));
