...
uniform float _webgl_c72812b39ae458b : register(c30);
uniform float3 _webgl_3b3710b9db4788a7 : register(c31);
uniform float _webgl_5985a6d987efdfc3 : register(c32);
uniform float _webgl_ae2115093f2ac183 : register(c33);
uniform float3 _webgl_2d459f8069f64681 : register(c34);
...
(_webgl_48742813565ac55d = max(((_webgl_1c82dc879cda6ae2 - sqrt(dot(_webgl_11482133dc10ada, _webgl_11482133dc10ada))) / _webgl_1c82dc879cda6ae2), 0.0));
(_webgl_9251dcdacdfa452 = _webgl_48742813565ac55d);
if ((_webgl_48742813565ac55d > 9.9999997e-06))
{
float _webgl_f05a73b03fcb4961 = {0.0};
(_webgl_f05a73b03fcb4961 = clamp(((dot(_webgl_d3a0349fad6621fb, _webgl_a8a39767ea2c8eb7) - _webgl_34ab7d99e8e69aa4) / (_webgl_e6010fd023fb284f - _webgl_34ab7d99e8e69aa4)), 0.0, 1.0));
(_webgl_9251dcdacdfa452 = (_webgl_48742813565ac55d * (_webgl_f05a73b03fcb4961 * (_webgl_f05a73b03fcb4961 * (3.0 - (2.0 * _webgl_f05a73b03fcb4961))))));
...
(_webgl_bb4c022d8fffa1de = exp2((_webgl_8e684f5904e88831 * 11.0)));
float _webgl_6cd3ea4a4d7f2e24 = {0.0};
(_webgl_6cd3ea4a4d7f2e24 = max((_webgl_bb4c022d8fffa1de * lerp(1.0, (1.0 / (1.0 + (_webgl_bb4c022d8fffa1de * ((1.0 / clamp(sqrt(dot(_webgl_f28d072c82c61bea, _webgl_f28d072c82c61bea)), 0.0, 1.0)) - 1.0)))), _webgl_c72812b39ae458b)), 9.9999997e-05));
(_webgl_9251dcdacdfa452 = (_webgl_9251dcdacdfa452 * ((pow(max(dot(normalize(((-_webgl_d3a0349fad6621fb) + _webgl_dbb0b86db3589565)), _webgl_d189f73da6eb4d5b), 0.0), _webgl_6cd3ea4a4d7f2e24) * (_webgl_6cd3ea4a4d7f2e24 + 2.0)) / 8.0)));
...
(_webgl_17eaf291e44ff974 = normalize(_webgl_11482133dc10ada));
float _webgl_9ba938eda1810eef = {0.0};
float _webgl_6845b595a6db2b36 = {0.0};
(_webgl_6845b595a6db2b36 = dot(_webgl_11482133dc10ada, _webgl_11482133dc10ada));
float _webgl_40d3fc5bec147c69 = {0.0};
(_webgl_40d3fc5bec147c69 = (1.0 / _webgl_2f0c4fd3d54f412));
(_webgl_9ba938eda1810eef = ((1.0 / (_webgl_6845b595a6db2b36 + 1.0)) * 16.0));
float _webgl_52d99dd0fc76c0e8 = {0.0};
(_webgl_52d99dd0fc76c0e8 = (_webgl_6845b595a6db2b36 * (_webgl_40d3fc5bec147c69 * _webgl_40d3fc5bec147c69)));
float _webgl_8a1c983d2a5521d3 = {0.0};
(_webgl_8a1c983d2a5521d3 = clamp((1.0 - (_webgl_52d99dd0fc76c0e8 * _webgl_52d99dd0fc76c0e8)), 0.0, 1.0));
(_webgl_9ba938eda1810eef = (_webgl_9ba938eda1810eef * (_webgl_8a1c983d2a5521d3 * _webgl_8a1c983d2a5521d3)));
(_webgl_9251dcdacdfa452 = _webgl_9ba938eda1810eef);
if ((_webgl_9ba938eda1810eef > 9.9999997e-06))
{
float _webgl_a8edb34b463f3ac3 = {0.0};
(_webgl_a8edb34b463f3ac3 = clamp(((dot(_webgl_17eaf291e44ff974, _webgl_c74e73a88f49c8c7) - _webgl_b1fe332e1acaed26) / (_webgl_e3e131ff0e27f0c0 - _webgl_b1fe332e1acaed26)), 0.0, 1.0));
(_webgl_9251dcdacdfa452 = (_webgl_9ba938eda1810eef * (_webgl_a8edb34b463f3ac3 * (_webgl_a8edb34b463f3ac3 * (3.0 - (2.0 * _webgl_a8edb34b463f3ac3))))));
(_webgl_9251dcdacdfa452 = (_webgl_9251dcdacdfa452 * max(dot(_webgl_d189f73da6eb4d5b, (-_webgl_17eaf291e44ff974)), 0.0)));
...
(_webgl_24698dc60b28d11 = max((_webgl_2ef05ecaa6259cbe * lerp(1.0, (1.0 / (1.0 + (_webgl_2ef05ecaa6259cbe * ((1.0 / clamp(sqrt(dot(_webgl_f28d072c82c61bea, _webgl_f28d072c82c61bea)), 0.0, 1.0)) - 1.0)))), _webgl_c72812b39ae458b)), 9.9999997e-05));
(_webgl_9251dcdacdfa452 = (_webgl_9251dcdacdfa452 * ((pow(max(dot(normalize(((-_webgl_17eaf291e44ff974) + _webgl_dbb0b86db3589565)), _webgl_d189f73da6eb4d5b), 0.0), _webgl_24698dc60b28d11) * (_webgl_24698dc60b28d11 + 2.0)) / 8.0)));
...
(_webgl_af838643f97a28e8 = max(((_webgl_21fed8ee50175509 - sqrt(dot(_webgl_11482133dc10ada, _webgl_11482133dc10ada))) / _webgl_21fed8ee50175509), 0.0));
(_webgl_9251dcdacdfa452 = _webgl_af838643f97a28e8);
if ((_webgl_af838643f97a28e8 > 9.9999997e-06))
{
float _webgl_b3646d04812e7a4a = {0.0};
(_webgl_b3646d04812e7a4a = clamp(((dot(_webgl_61c6aec6c44642a1, _webgl_8eda54b98f40e5ba) - _webgl_b4ce66a72995d6d3) / (_webgl_af8a456fd59f087a - _webgl_b4ce66a72995d6d3)), 0.0, 1.0));
(_webgl_9251dcdacdfa452 = (_webgl_af838643f97a28e8 * (_webgl_b3646d04812e7a4a * (_webgl_b3646d04812e7a4a * (3.0 - (2.0 * _webgl_b3646d04812e7a4a))))));
(_webgl_9251dcdacdfa452 = (_webgl_9251dcdacdfa452 * max(dot(_webgl_d189f73da6eb4d5b, (-_webgl_61c6aec6c44642a1)), 0.0)));
float4 _webgl_d0ffc41c39ff708f = {0.0, 0.0, 0.0, 0.0};
float4 _webgl_8badbc4aa9205681 = {0.0, 0.0, 0.0, 0.0};
(_webgl_8badbc4aa9205681.w = 1.0);
(_webgl_8badbc4aa9205681.xyz = _webgl_5c81bf65ffac0762);
float4 _webgl_e760ed8adca1c9c3 = {0.0, 0.0, 0.0, 0.0};
(_webgl_e760ed8adca1c9c3 = mul(transpose(_webgl_7d0ab9d59dac7bb2), _webgl_8badbc4aa9205681));
(_webgl_d0ffc41c39ff708f.zw = _webgl_e760ed8adca1c9c3.zw);
(_webgl_d0ffc41c39ff708f.xy = (_webgl_e760ed8adca1c9c3.xy / _webgl_e760ed8adca1c9c3.w));
float _webgl_dbbf1e363cd7e5a8 = {0.0};
(_webgl_dbbf1e363cd7e5a8 = ((sqrt(dot(_webgl_11482133dc10ada, _webgl_11482133dc10ada)) * _webgl_c2d277a61d53c00d.w) + _webgl_c2d277a61d53c00d.z));
float4 _webgl_6a9bcb091df1cdf6 = {0.0, 0.0, 0.0, 0.0};
(_webgl_6a9bcb091df1cdf6 = gl_texture2D(_webgl_f7d454a6f4a6892c, _webgl_d0ffc41c39ff708f.xy));
float3 _webgl_a52374383578cc70 = {0.0, 0.0, 0.0};
(_webgl_a52374383578cc70.z = 0.0);
(_webgl_a52374383578cc70.x = ((_webgl_6a9bcb091df1cdf6.y * 0.0039215689) + _webgl_6a9bcb091df1cdf6.x));
(_webgl_a52374383578cc70.y = ((_webgl_6a9bcb091df1cdf6.w * 0.0039215689) + _webgl_6a9bcb091df1cdf6.z));
float _webgl_e47f7fad6c31aebc = {0.0};
(_webgl_e47f7fad6c31aebc = (_webgl_c2d277a61d53c00d.y * _webgl_dbbf1e363cd7e5a8));
float _webgl_56077667bfd6d861 = {0.0};
(_webgl_56077667bfd6d861 = max((_webgl_a52374383578cc70.y - (_webgl_a52374383578cc70.x * _webgl_a52374383578cc70.x)), (_webgl_e47f7fad6c31aebc * _webgl_e47f7fad6c31aebc)));
float _webgl_b190a86bc7f938d2 = {0.0};
(_webgl_b190a86bc7f938d2 = (_webgl_dbbf1e363cd7e5a8 - _webgl_a52374383578cc70.x));
float _webgl_95e254f0ea5b5564 = {0.0};
(_webgl_95e254f0ea5b5564 = clamp((((_webgl_56077667bfd6d861 / (_webgl_56077667bfd6d861 + (_webgl_b190a86bc7f938d2 * _webgl_b190a86bc7f938d2))) - 0.1) / 0.89999998), 0.0, 1.0));
float _webgl_8e449eeb6739befe = {0.0};
if ((_webgl_dbbf1e363cd7e5a8 <= _webgl_a52374383578cc70.x))
{
(_webgl_8e449eeb6739befe = 1.0);
}
else
{
(_webgl_8e449eeb6739befe = _webgl_95e254f0ea5b5564);
}
(_webgl_9251dcdacdfa452 = (_webgl_9251dcdacdfa452 * _webgl_8e449eeb6739befe));
...
(_webgl_eb9e29ad556d5876 = exp2((_webgl_8e684f5904e88831 * 11.0)));
float _webgl_6430cdf0dbc8e939 = {0.0};
(_webgl_6430cdf0dbc8e939 = max((_webgl_eb9e29ad556d5876 * lerp(1.0, (1.0 / (1.0 + (_webgl_eb9e29ad556d5876 * ((1.0 / clamp(sqrt(dot(_webgl_f28d072c82c61bea, _webgl_f28d072c82c61bea)), 0.0, 1.0)) - 1.0)))), _webgl_c72812b39ae458b)), 9.9999997e-05));
(_webgl_9251dcdacdfa452 = (_webgl_9251dcdacdfa452 * ((pow(max(dot(normalize(((-_webgl_61c6aec6c44642a1) + _webgl_dbb0b86db3589565)), _webgl_d189f73da6eb4d5b), 0.0), _webgl_6430cdf0dbc8e939) * (_webgl_6430cdf0dbc8e939 + 2.0)) / 8.0)));
...
(_webgl_909dd7b8eca80202 = lerp((_webgl_4daadd2dc6febc51.xyz * _webgl_540f7c123bdf52c0), (_webgl_3d74e5997dd7c222 + (_webgl_82fa7c9f93cc7839.xyz * _webgl_7ae668e5b64ca8de)), _webgl_acb134d5a49c2148));
(out_webgl_9b98566002e557b5.xyz = _webgl_909dd7b8eca80202);
...
(_webgl_9090da22dad28bf7 = (_webgl_5c81bf65ffac0762 - _webgl_35c9514d594e36f3));
(out_webgl_9b98566002e557b5.xyz = lerp(_webgl_3b3710b9db4788a7, out_webgl_9b98566002e557b5.xyz, clamp(exp(((-sqrt(dot(_webgl_9090da22dad28bf7, _webgl_9090da22dad28bf7))) * _webgl_5985a6d987efdfc3)), 0.0, 1.0)));
(out_webgl_9b98566002e557b5.xyz = out_webgl_9b98566002e557b5.xyz);
(out_webgl_9b98566002e557b5.xyz = out_webgl_9b98566002e557b5.xyz);
(out_webgl_9b98566002e557b5.w = 1.0);
(out_webgl_9b98566002e557b5.x += 0.94633299);
}
void f_initGlobals()
{
