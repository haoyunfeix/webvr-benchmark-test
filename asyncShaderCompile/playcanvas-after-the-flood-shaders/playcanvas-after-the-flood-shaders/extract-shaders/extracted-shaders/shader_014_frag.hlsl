...
uniform float3 _webgl_16cc37db4120bb6a : register(c15);
uniform float _webgl_78412eb5117922b0 : register(c16);
...
float _webgl_50accb4840ab418c = {0.0};
(_webgl_50accb4840ab418c = (clamp(dot(_webgl_82fa7c9f93cc7839, (-_webgl_cc88c95a9917294)), 0.0, 1.0) * clamp(dot(normalize((_webgl_35c9514d594e36f3 - _webgl_5c81bf65ffac0762)), _webgl_82fa7c9f93cc7839), 0.0, 1.0)));
(_webgl_50accb4840ab418c = (_webgl_50accb4840ab418c * ((1.0 / (dot(_webgl_11482133dc10ada, _webgl_11482133dc10ada) + 1.0)) * 4.0)));
float _webgl_b3646d04812e7a4a = {0.0};
(_webgl_b3646d04812e7a4a = clamp((_webgl_50accb4840ab418c + 0.0024999999), 0.0, 1.0));
(_webgl_50accb4840ab418c = _webgl_b3646d04812e7a4a);
float4 _webgl_a42847ea414619a6 = {0.0, 0.0, 0.0, 0.0};
float4 _webgl_8badbc4aa9205681 = {0.0, 0.0, 0.0, 0.0};
(_webgl_8badbc4aa9205681 = gl_texture2D(_webgl_b15f7cf9d8241198, _webgl_a0b62b4d8ddcd62b));
(_webgl_a42847ea414619a6.w = _webgl_8badbc4aa9205681.w);
(_webgl_a42847ea414619a6.xyz = pow(_webgl_8badbc4aa9205681.xyz, float3(2.2, 2.2, 2.2)));
(_webgl_61c6aec6c44642a1 = (((_webgl_a42847ea414619a6.xyz * _webgl_78412eb5117922b0) * (200.0 * _webgl_b3646d04812e7a4a)) * _webgl_e5253e8e18397069.w));
(out_webgl_9b98566002e557b5.xyz = (out_webgl_9b98566002e557b5.xyz + _webgl_61c6aec6c44642a1));
...
(out_webgl_9b98566002e557b5.x += 0.12742196);
}
void f_initGlobals()
{
