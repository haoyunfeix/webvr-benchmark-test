...
uniform float _webgl_ae2115093f2ac183 : register(c25);
...
uniform float _webgl_d5b4509b9521f54c : register(c31);
...
static const uint _webgl_bb15c76ae884963b = 3;
...
(_webgl_9251dcdacdfa452 = (_webgl_9251dcdacdfa452 * max(dot(_webgl_f28d072c82c61bea, (-_webgl_24698dc60b28d11)), 0.0)));
...
(_webgl_9251dcdacdfa452 = (_webgl_9251dcdacdfa452 * ((pow(max(dot(normalize(((-_webgl_24698dc60b28d11) + _webgl_822b69d8b2db705f)), _webgl_f28d072c82c61bea), 0.0), _webgl_9090da22dad28bf7) * (_webgl_9090da22dad28bf7 + 2.0)) / 8.0)));
...
(out_webgl_9b98566002e557b5.x += 0.89503568);
}
void f_initGlobals()
{
