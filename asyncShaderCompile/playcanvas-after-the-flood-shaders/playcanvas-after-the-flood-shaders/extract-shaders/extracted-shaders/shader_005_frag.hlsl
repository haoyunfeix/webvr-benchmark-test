...
(_webgl_17eaf291e44ff974 = max(((_webgl_1c82dc879cda6ae2 - sqrt(dot(_webgl_11482133dc10ada, _webgl_11482133dc10ada))) / _webgl_1c82dc879cda6ae2), 0.0));
(_webgl_9251dcdacdfa452 = _webgl_17eaf291e44ff974);
if ((_webgl_17eaf291e44ff974 > 9.9999997e-06))
{
float _webgl_265b07338d1f26ef = {0.0};
(_webgl_265b07338d1f26ef = clamp(((dot(_webgl_6cd3ea4a4d7f2e24, _webgl_a8a39767ea2c8eb7) - _webgl_34ab7d99e8e69aa4) / (_webgl_e6010fd023fb284f - _webgl_34ab7d99e8e69aa4)), 0.0, 1.0));
(_webgl_9251dcdacdfa452 = (_webgl_17eaf291e44ff974 * (_webgl_265b07338d1f26ef * (_webgl_265b07338d1f26ef * (3.0 - (2.0 * _webgl_265b07338d1f26ef))))));
(_webgl_9251dcdacdfa452 = (_webgl_9251dcdacdfa452 * max(dot(_webgl_d189f73da6eb4d5b, (-_webgl_6cd3ea4a4d7f2e24)), 0.0)));
float4 _webgl_a5b79ca57fed6a69 = {0.0, 0.0, 0.0, 0.0};
float4 _webgl_40d3fc5bec147c69 = {0.0, 0.0, 0.0, 0.0};
(_webgl_40d3fc5bec147c69.w = 1.0);
(_webgl_40d3fc5bec147c69.xyz = _webgl_5c81bf65ffac0762);
float4 _webgl_dbaa033991f73c9d = {0.0, 0.0, 0.0, 0.0};
(_webgl_dbaa033991f73c9d = mul(transpose(_webgl_80ac1a8d68a70197), _webgl_40d3fc5bec147c69));
(_webgl_a5b79ca57fed6a69.zw = _webgl_dbaa033991f73c9d.zw);
(_webgl_a5b79ca57fed6a69.xy = (_webgl_dbaa033991f73c9d.xy / _webgl_dbaa033991f73c9d.w));
float _webgl_b17d0c6ffe6b625 = {0.0};
(_webgl_b17d0c6ffe6b625 = ((sqrt(dot(_webgl_11482133dc10ada, _webgl_11482133dc10ada)) * _webgl_41a0cad7d2087d04.w) + _webgl_41a0cad7d2087d04.z));
float4 _webgl_a8edb34b463f3ac3 = {0.0, 0.0, 0.0, 0.0};
(_webgl_a8edb34b463f3ac3 = gl_texture2D(_webgl_b153a7264c2e8600, _webgl_a5b79ca57fed6a69.xy));
float3 _webgl_2ef05ecaa6259cbe = {0.0, 0.0, 0.0};
(_webgl_2ef05ecaa6259cbe.z = 0.0);
(_webgl_2ef05ecaa6259cbe.x = ((_webgl_a8edb34b463f3ac3.y * 0.0039215689) + _webgl_a8edb34b463f3ac3.x));
(_webgl_2ef05ecaa6259cbe.y = ((_webgl_a8edb34b463f3ac3.w * 0.0039215689) + _webgl_a8edb34b463f3ac3.z));
float _webgl_24698dc60b28d11 = {0.0};
(_webgl_24698dc60b28d11 = (_webgl_41a0cad7d2087d04.y * _webgl_b17d0c6ffe6b625));
float _webgl_61c6aec6c44642a1 = {0.0};
(_webgl_61c6aec6c44642a1 = max((_webgl_2ef05ecaa6259cbe.y - (_webgl_2ef05ecaa6259cbe.x * _webgl_2ef05ecaa6259cbe.x)), (_webgl_24698dc60b28d11 * _webgl_24698dc60b28d11)));
float _webgl_af838643f97a28e8 = {0.0};
(_webgl_af838643f97a28e8 = (_webgl_b17d0c6ffe6b625 - _webgl_2ef05ecaa6259cbe.x));
float _webgl_b3646d04812e7a4a = {0.0};
(_webgl_b3646d04812e7a4a = clamp((((_webgl_61c6aec6c44642a1 / (_webgl_61c6aec6c44642a1 + (_webgl_af838643f97a28e8 * _webgl_af838643f97a28e8))) - 0.1) / 0.89999998), 0.0, 1.0));
float _webgl_7edc71e79ab928c1 = {0.0};
if ((_webgl_b17d0c6ffe6b625 <= _webgl_2ef05ecaa6259cbe.x))
{
(_webgl_7edc71e79ab928c1 = 1.0);
}
else
{
(_webgl_7edc71e79ab928c1 = _webgl_b3646d04812e7a4a);
}
(_webgl_9251dcdacdfa452 = (_webgl_9251dcdacdfa452 * _webgl_7edc71e79ab928c1));
...
(_webgl_8badbc4aa9205681 = exp2((_webgl_8e684f5904e88831 * 11.0)));
float _webgl_e760ed8adca1c9c3 = {0.0};
(_webgl_e760ed8adca1c9c3 = max((_webgl_8badbc4aa9205681 * lerp(1.0, (1.0 / (1.0 + (_webgl_8badbc4aa9205681 * ((1.0 / clamp(sqrt(dot(_webgl_f28d072c82c61bea, _webgl_f28d072c82c61bea)), 0.0, 1.0)) - 1.0)))), _webgl_c72812b39ae458b)), 9.9999997e-05));
(_webgl_9251dcdacdfa452 = (_webgl_9251dcdacdfa452 * ((pow(max(dot(normalize(((-_webgl_6cd3ea4a4d7f2e24) + _webgl_dbb0b86db3589565)), _webgl_d189f73da6eb4d5b), 0.0), _webgl_e760ed8adca1c9c3) * (_webgl_e760ed8adca1c9c3 + 2.0)) / 8.0)));
...
(_webgl_80f9c2f994f34f1e = lerp((_webgl_4daadd2dc6febc51.xyz * _webgl_540f7c123bdf52c0), (_webgl_3d74e5997dd7c222 + (_webgl_82fa7c9f93cc7839.xyz * _webgl_7ae668e5b64ca8de)), _webgl_acb134d5a49c2148));
(out_webgl_9b98566002e557b5.xyz = _webgl_80f9c2f994f34f1e);
...
(_webgl_6a9bcb091df1cdf6 = (_webgl_5c81bf65ffac0762 - _webgl_35c9514d594e36f3));
(out_webgl_9b98566002e557b5.xyz = lerp(_webgl_3b3710b9db4788a7, out_webgl_9b98566002e557b5.xyz, clamp(exp(((-sqrt(dot(_webgl_6a9bcb091df1cdf6, _webgl_6a9bcb091df1cdf6))) * _webgl_5985a6d987efdfc3)), 0.0, 1.0)));
(out_webgl_9b98566002e557b5.xyz = out_webgl_9b98566002e557b5.xyz);
(out_webgl_9b98566002e557b5.xyz = out_webgl_9b98566002e557b5.xyz);
(out_webgl_9b98566002e557b5.w = 1.0);
(out_webgl_9b98566002e557b5.x += 0.96447784);
}
void f_initGlobals()
{
