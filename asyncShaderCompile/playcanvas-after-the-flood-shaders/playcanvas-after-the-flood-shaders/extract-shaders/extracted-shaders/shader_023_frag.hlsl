...
uniform float _webgl_c69990ec6a7a5be2 : register(c26);
uniform float3 _webgl_2d459f8069f64681 : register(c27);
uniform float3 _webgl_e2179ae4f2cb06c9 : register(c28);
...
(_webgl_af838643f97a28e8 = normalize(_webgl_11482133dc10ada));
float _webgl_43330e4e377f8a31 = {0.0};
float _webgl_7edc71e79ab928c1 = {0.0};
(_webgl_7edc71e79ab928c1 = dot(_webgl_11482133dc10ada, _webgl_11482133dc10ada));
float _webgl_8badbc4aa9205681 = {0.0};
(_webgl_8badbc4aa9205681 = (1.0 / _webgl_1c82dc879cda6ae2));
(_webgl_43330e4e377f8a31 = ((1.0 / (_webgl_7edc71e79ab928c1 + 1.0)) * 16.0));
float _webgl_80ff87972598a2a5 = {0.0};
(_webgl_80ff87972598a2a5 = (_webgl_7edc71e79ab928c1 * (_webgl_8badbc4aa9205681 * _webgl_8badbc4aa9205681)));
float _webgl_80f9c2f994f34f1e = {0.0};
(_webgl_80f9c2f994f34f1e = clamp((1.0 - (_webgl_80ff87972598a2a5 * _webgl_80ff87972598a2a5)), 0.0, 1.0));
(_webgl_43330e4e377f8a31 = (_webgl_43330e4e377f8a31 * (_webgl_80f9c2f994f34f1e * _webgl_80f9c2f994f34f1e)));
(_webgl_9251dcdacdfa452 = _webgl_43330e4e377f8a31);
if ((_webgl_43330e4e377f8a31 > 9.9999997e-06))
{
float _webgl_6a9bcb091df1cdf6 = {0.0};
(_webgl_6a9bcb091df1cdf6 = clamp(((dot(_webgl_af838643f97a28e8, _webgl_a8a39767ea2c8eb7) - _webgl_34ab7d99e8e69aa4) / (_webgl_e6010fd023fb284f - _webgl_34ab7d99e8e69aa4)), 0.0, 1.0));
(_webgl_9251dcdacdfa452 = (_webgl_43330e4e377f8a31 * (_webgl_6a9bcb091df1cdf6 * (_webgl_6a9bcb091df1cdf6 * (3.0 - (2.0 * _webgl_6a9bcb091df1cdf6))))));
(_webgl_9251dcdacdfa452 = (_webgl_9251dcdacdfa452 * max(dot(_webgl_d189f73da6eb4d5b, (-_webgl_af838643f97a28e8)), 0.0)));
float4 _webgl_6964363e8f66a7c4 = {0.0, 0.0, 0.0, 0.0};
float4 _webgl_e47f7fad6c31aebc = {0.0, 0.0, 0.0, 0.0};
(_webgl_e47f7fad6c31aebc.w = 1.0);
(_webgl_e47f7fad6c31aebc.xyz = _webgl_5c81bf65ffac0762);
float4 _webgl_56077667bfd6d861 = {0.0, 0.0, 0.0, 0.0};
(_webgl_56077667bfd6d861 = mul(transpose(_webgl_80ac1a8d68a70197), _webgl_e47f7fad6c31aebc));
(_webgl_6964363e8f66a7c4.zw = _webgl_56077667bfd6d861.zw);
(_webgl_6964363e8f66a7c4.xy = (_webgl_56077667bfd6d861.xy / _webgl_56077667bfd6d861.w));
float _webgl_a1d7804b0b008b0e = {0.0};
(_webgl_a1d7804b0b008b0e = ((sqrt(dot(_webgl_11482133dc10ada, _webgl_11482133dc10ada)) * _webgl_41a0cad7d2087d04.w) + _webgl_41a0cad7d2087d04.z));
float4 _webgl_95e254f0ea5b5564 = {0.0, 0.0, 0.0, 0.0};
(_webgl_95e254f0ea5b5564 = gl_texture2D(_webgl_b153a7264c2e8600, _webgl_6964363e8f66a7c4.xy));
float3 _webgl_8e449eeb6739befe = {0.0, 0.0, 0.0};
(_webgl_8e449eeb6739befe.z = 0.0);
(_webgl_8e449eeb6739befe.x = ((_webgl_95e254f0ea5b5564.y * 0.0039215689) + _webgl_95e254f0ea5b5564.x));
(_webgl_8e449eeb6739befe.y = ((_webgl_95e254f0ea5b5564.w * 0.0039215689) + _webgl_95e254f0ea5b5564.z));
float _webgl_eb9e29ad556d5876 = {0.0};
(_webgl_eb9e29ad556d5876 = (_webgl_41a0cad7d2087d04.y * _webgl_a1d7804b0b008b0e));
float _webgl_6430cdf0dbc8e939 = {0.0};
(_webgl_6430cdf0dbc8e939 = max((_webgl_8e449eeb6739befe.y - (_webgl_8e449eeb6739befe.x * _webgl_8e449eeb6739befe.x)), (_webgl_eb9e29ad556d5876 * _webgl_eb9e29ad556d5876)));
float _webgl_909dd7b8eca80202 = {0.0};
(_webgl_909dd7b8eca80202 = (_webgl_a1d7804b0b008b0e - _webgl_8e449eeb6739befe.x));
float _webgl_9090da22dad28bf7 = {0.0};
(_webgl_9090da22dad28bf7 = clamp((((_webgl_6430cdf0dbc8e939 / (_webgl_6430cdf0dbc8e939 + (_webgl_909dd7b8eca80202 * _webgl_909dd7b8eca80202))) - 0.1) / 0.89999998), 0.0, 1.0));
float _webgl_14255a09eade23c1 = {0.0};
if ((_webgl_a1d7804b0b008b0e <= _webgl_8e449eeb6739befe.x))
{
(_webgl_14255a09eade23c1 = 1.0);
}
else
{
(_webgl_14255a09eade23c1 = _webgl_9090da22dad28bf7);
}
(_webgl_9251dcdacdfa452 = (_webgl_9251dcdacdfa452 * _webgl_14255a09eade23c1));
...
(_webgl_4a15523e4032dda7 = exp2((_webgl_8e684f5904e88831 * 11.0)));
float _webgl_1d1ddb76fbcf772a = {0.0};
(_webgl_1d1ddb76fbcf772a = max((_webgl_4a15523e4032dda7 * lerp(1.0, (1.0 / (1.0 + (_webgl_4a15523e4032dda7 * ((1.0 / clamp(sqrt(dot(_webgl_f28d072c82c61bea, _webgl_f28d072c82c61bea)), 0.0, 1.0)) - 1.0)))), _webgl_c72812b39ae458b)), 9.9999997e-05));
(_webgl_9251dcdacdfa452 = (_webgl_9251dcdacdfa452 * ((pow(max(dot(normalize(((-_webgl_af838643f97a28e8) + _webgl_dbb0b86db3589565)), _webgl_d189f73da6eb4d5b), 0.0), _webgl_1d1ddb76fbcf772a) * (_webgl_1d1ddb76fbcf772a + 2.0)) / 8.0)));
...
(_webgl_e2e2a31b2325c72 = lerp((_webgl_d7c0aae5deddf4ea * _webgl_540f7c123bdf52c0), (_webgl_3d74e5997dd7c222 + (_webgl_9d2f5706d0aa9ead.xyz * _webgl_9d2f5706d0aa9ead.w)), _webgl_acb134d5a49c2148));
(out_webgl_9b98566002e557b5.xyz = _webgl_e2e2a31b2325c72);
...
float3 _webgl_1a6c2875eb51b665 = {0.0, 0.0, 0.0};
(_webgl_1a6c2875eb51b665 = (_webgl_5c81bf65ffac0762 - _webgl_35c9514d594e36f3));
(out_webgl_9b98566002e557b5.xyz = lerp(_webgl_3b3710b9db4788a7, out_webgl_9b98566002e557b5.xyz, clamp(exp(((-sqrt(dot(_webgl_1a6c2875eb51b665, _webgl_1a6c2875eb51b665))) * _webgl_5985a6d987efdfc3)), 0.0, 1.0)));
(out_webgl_9b98566002e557b5.xyz = out_webgl_9b98566002e557b5.xyz);
(out_webgl_9b98566002e557b5.xyz = out_webgl_9b98566002e557b5.xyz);
(out_webgl_9b98566002e557b5.w = 1.0);
(out_webgl_9b98566002e557b5.x += 0.92826384);
}
void f_initGlobals()
{
(_webgl_9d2f5706d0aa9ead = float4(0.0, 0.0, 0.0, 0.0));
