...
uniform float3 _webgl_f836b86ccb55856c : register(c30);
...
static const uint _webgl_5c7c81c103b6fbdd = 7;
...
(_webgl_14255a09eade23c1 = exp2((_webgl_8e684f5904e88831 * 11.0)));
float _webgl_4a15523e4032dda7 = {0.0};
(_webgl_4a15523e4032dda7 = max((_webgl_14255a09eade23c1 * lerp(1.0, (1.0 / (1.0 + (_webgl_14255a09eade23c1 * ((1.0 / clamp(sqrt(dot(_webgl_cfb863ec5a9ad847, _webgl_cfb863ec5a9ad847)), 0.0, 1.0)) - 1.0)))), _webgl_c72812b39ae458b)), 9.9999997e-05));
(_webgl_9251dcdacdfa452 = (_webgl_9251dcdacdfa452 * ((pow(max(dot(normalize(((-_webgl_61c6aec6c44642a1) + _webgl_3c71294eb0cb894e)), _webgl_d189f73da6eb4d5b), 0.0), _webgl_4a15523e4032dda7) * (_webgl_4a15523e4032dda7 + 2.0)) / 8.0)));
...
(_webgl_1d1ddb76fbcf772a = (_webgl_5c81bf65ffac0762 - _webgl_f836b86ccb55856c));
float2 _webgl_e2e2a31b2325c72 = {0.0, 0.0};
(_webgl_e2e2a31b2325c72 = (((_webgl_1d1ddb76fbcf772a.xz / float2(16.0, -16.0)) * 0.5) + 0.5));
(_webgl_62c9d5f5e7dd3b43 = _webgl_e2e2a31b2325c72);
(_webgl_feaeedca589c1a59 = 0.0);
if (((((_webgl_1d1ddb76fbcf772a.x > -1.1) && (_webgl_1d1ddb76fbcf772a.x < 1.1)) && (_webgl_1d1ddb76fbcf772a.z > -1.1)) && (_webgl_1d1ddb76fbcf772a.z < 1.1)))
{
...
{
{LOOP for(int _webgl_d8830104945d6cbe = {0}; (_webgl_d8830104945d6cbe < 8); (_webgl_d8830104945d6cbe++))
{
float4 _webgl_efb9abf9cf1319d2 = {0.0, 0.0, 0.0, 0.0};
(_webgl_efb9abf9cf1319d2 = gl_texture2D(_webgl_5c7c81c103b6fbdd, (_webgl_62c9d5f5e7dd3b43 + _webgl_a1324e053028e35c[int_ctor(clamp(float_ctor(_webgl_d8830104945d6cbe), 0.0, 7.0))])));
float _webgl_468e885b7f29418e = {0.0};
(_webgl_468e885b7f29418e = _webgl_efb9abf9cf1319d2.w);
float3 _webgl_45dfddb747caee = {0.0, 0.0, 0.0};
if ((_webgl_feaeedca589c1a59 < _webgl_efb9abf9cf1319d2.w))
{
float3 _webgl_b59ec816fb13ac1d = {0.0, 0.0, 0.0};
(_webgl_b59ec816fb13ac1d.xz = float2(0.125, 1.0));
(_webgl_b59ec816fb13ac1d.y = _webgl_468e885b7f29418e);
(_webgl_45dfddb747caee = _webgl_b59ec816fb13ac1d);
}
else
{
(_webgl_45dfddb747caee = float3(0.0, 0.0, 0.0));
}
(_webgl_91d068a447762d9f = (_webgl_91d068a447762d9f + _webgl_45dfddb747caee));
}
}
...
float4 _webgl_609625e3f64a0f19 = {0.0, 0.0, 0.0, 0.0};
(_webgl_609625e3f64a0f19 = gl_texture2D(_webgl_5c7c81c103b6fbdd, _webgl_e2e2a31b2325c72));
(_webgl_540f7c123bdf52c0 = (_webgl_540f7c123bdf52c0 * lerp(1.0, (1.0 - clamp(((_webgl_609625e3f64a0f19.x - _webgl_609625e3f64a0f19.y) * 4.0), 0.0, 1.0)), clamp(_webgl_cc88c95a9917294.y, 0.0, 1.0))));
}
float3 _webgl_ea6b6b1beb91da53 = {0.0, 0.0, 0.0};
(_webgl_ea6b6b1beb91da53 = lerp((_webgl_d7c0aae5deddf4ea * _webgl_540f7c123bdf52c0), (_webgl_3d74e5997dd7c222 + (_webgl_9d2f5706d0aa9ead.xyz * _webgl_9d2f5706d0aa9ead.w)), _webgl_acb134d5a49c2148));
(out_webgl_9b98566002e557b5.xyz = _webgl_ea6b6b1beb91da53);
(out_webgl_9b98566002e557b5.xyz = (out_webgl_9b98566002e557b5.xyz + _webgl_2d459f8069f64681));
float3 _webgl_e9159e945655b007 = {0.0, 0.0, 0.0};
(_webgl_e9159e945655b007 = (_webgl_5c81bf65ffac0762 - _webgl_35c9514d594e36f3));
(out_webgl_9b98566002e557b5.xyz = lerp(_webgl_3b3710b9db4788a7, out_webgl_9b98566002e557b5.xyz, clamp(exp(((-sqrt(dot(_webgl_e9159e945655b007, _webgl_e9159e945655b007))) * _webgl_5985a6d987efdfc3)), 0.0, 1.0)));
(out_webgl_9b98566002e557b5.xyz = out_webgl_9b98566002e557b5.xyz);
(out_webgl_9b98566002e557b5.xyz = out_webgl_9b98566002e557b5.xyz);
(out_webgl_9b98566002e557b5.w = 1.0);
(out_webgl_9b98566002e557b5.x += 0.69696283);
}
void f_initGlobals()
{
(_webgl_9d2f5706d0aa9ead = float4(0.0, 0.0, 0.0, 0.0));
